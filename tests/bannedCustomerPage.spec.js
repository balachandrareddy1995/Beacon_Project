...
test('As a User to Validate the ID Proof Document in ID Proof Document dropdown from a BannedCustome Pag',async()=>{
 ...
 test('Verify Warning Message CustmoreName After clicking on the Search Button',async()=>{
  ...
  test('AS a User To Enter the name in the CustomerName field.', async () => {
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet","Customer Name Field - ECP Validations(Positive)", "CustomerName");
  ...
  test('AS a User To Enter the name in the CustomerName field More then 50 character it should allowed only 0-50',async()=>{ 
    ...
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet","Customer Name Field - ECP Validations(Min&Max)","CustomerName");
    const customerName = testData[0];
    console.log(customerName);
    if (customerName) {
      await bannedCustomerPage.enterCustomerName(customerName);
...
test('As a User to Enter the Valid Customer Name in the CustomerName field',async()=>{
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustmoreSheet","Customer Name Field - ECP Validations(Positive)", "CustomerName");
    const customerName = testData[0];
  ...
  test('As a User Choose the Select Id Proof Document All', async () => {
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Banned Customer Page-Form", "IDProofDocument");
  ...
  test('As a User to Enter the Id ProofNo in the Id proofNo field is allowing 0 to 20',async()=>{
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Banned Customer Page-Form", "IDProofNumber");
  ...
  test('As a User to verify the No records found after click on the Search Button.',async()=>{
    ...
    const testData1 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Banned Customer Page-Form", "IDProofDocument");
...
const testData2 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet" ,"Banned Customer Page-Form", "IDProofNumber");
...
test('Entere the Special Character from the Customer Name field and click on Search Button to Verify the Warning Message.',async()=>{
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Banned Customer Page-Error Guessing - SpecialChar", "CustomerName");
    const customerName = testData[0];
    if (customerName) {
      await bannedCustomerPage.enterCustomerName(customerName);
  } else {
...
test('Entere the Special Character from the IdProof Number field and click on Search Button to Verify the Warning Message.',async()=>{
    ...
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Banned Customer Page-Error Guessing - SpecialChar", "IDProofNumber");
...
test('verify the Warning Message,When Enter the Special char from CustomerName and IdProof Number',async()=>{
  ...
  test('When click on the Close Button to redirect into the Home page to Verify the any object from Home Page,',async()=>{
    ...
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "HomePageUrl", "VerifyHomePageURL");
  ...
  test('Enter Valid Input into all the fields in a AddBannedCustomer Page',async()=>{
    const testData = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","Customer ID");
   ...
   const testData1 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","CustomerName");
  ...
  const testData2 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","MobileNumber");
  const mobilNumber=testData2[0];
    ...
    const testData3 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","Address");
   ...
   if(address){
    ...
    const testData4 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","IDProofDocument");
   ...
   if(document)
    ...
    const testData5 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add New Customer-Form","IDProofNumber");
  ...
  test('As a User to enter the SpecialCharcter from all the fields in Add BannedCustomer Page Should verify the Warning Message',async()=>{
    const testData= await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add new customer Form - Special Characters","Customer ID");
    const customerId = testData[0];
    if(customerId){
    console.log("customerId:"+customerId);
    await bannedCustomerPage.enterCustomerID(customerId);
    ...
    const testData1 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add new customer Form - Special Characters", "CustomerName");
    const customerName = testData1[0];
    ...
    const testData2 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add new customer Form - Special Characters","Address");
   ...
   if(address){
    ...
    const testData3= await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add new customer Form - Special Characters","IDProofNumber");
  ...
  test('As a User click on close button from Add Banned Customer Page.Redirect into the Banned Customer Page',async()=>{
    ...
    const bannedPageUrl= await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Add new customer page - Cancel Button - Redirection","VerifyBannedCustomerPageURL");
...
test('As a USer to enter the details from Add Banned customer Page,after to click on the save button.should show the "New Customer details added."',async()=>{
    ...
    await dashBoardPage.navigateToAddNewCustomerPage();
    await page.waitForLoadState('load');
   const testData1 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data","CustomerName");
   const customerName=testData1[0];
   console.log("customerName:"+customerName)
   if(customerName){
     await bannedCustomerPage.addBandCustmoreCustmoreName(customerName);
 ...
 const testData2 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data","MobileNumber");
 const mobilNumber=testData2[0];
   if(mobilNumber){
     const mNumber = mobilNumber.toString();
     console.log("Reading MobilNumber :"+mNumber)
   ...
   const testData3 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data","Address");
   const address=testData3[0];
  ...
  if(address){
   ...
   //document Type:
   const testData4 = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data","IDProofDocument");
   const document=testData4[0];
  ...
  if(document)
   ...
   const testData5= await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data","IDProofNumber");
   const IDProofNumber=testData5[0];
...
test('As a User, verify the input values from fields in a customer details form on the banned customer page.',{setTimeout:5000}, async () => {


  const customerName = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data", "CustomerName");
  const address = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data", "Address");
  const document = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data", "IDProofDocument");
  const IDProofNumber = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data", "IDProofNumber");
  const mobileNumber = await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "Create Add new customer form - Enter Valid Data", "MobileNumber");
...
test('As a User to enter the spectial character in Remarks filed from the customer details',async()=>{
  const remarksInput=await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "CustomerDetails From BannedCustomerPage-SpecialCharacter", "Remarks");
...
test('As a User to enter the valid Name for Remarks field,When click on save button,showes as a popup after to click on Yes,showes as a Customer details updated',async()=>{
   const remarksInput=await excelReader.readData("TestData/TestDataBeaconProject.xlsx", "BannedCustomerSheet", "CustomerDetails From BannedCustomerPage-Valid", "Remarks");
  await bannedCustomerPage.enterRemarkField(remarksInput[0]);
  await bannedCustomerPage.clickOnSaveButton();
  await bannedCustomerPage.yesButtonConfirmPopup();
